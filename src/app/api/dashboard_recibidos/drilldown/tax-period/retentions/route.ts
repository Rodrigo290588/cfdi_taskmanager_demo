...
import { listRetainedTaxDrilldown } from '@/lib/provider-tax-period-summary'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const rows = await listRetainedTaxDrilldown({
    ...
    console.error('Dashboard recibidos retenciones drilldown API error:', error)
