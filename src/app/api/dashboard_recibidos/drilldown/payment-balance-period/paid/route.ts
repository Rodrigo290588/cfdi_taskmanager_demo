...
import { listPaidInPeriodDrilldown } from '@/lib/provider-payment-balance-period-summary'
...
export async function GET(request: NextRequest) {
  try {
    ...
    const rows = await listPaidInPeriodDrilldown({
    ...
    console.error('Dashboard recibidos pagos del periodo drilldown API error:', error)
